...
/**
 * A sample application that creates HTML that shows image positions on a Google
 * Map according to the GPS data contained within each {@link GpsDirectory}, if
 * available.
 */
public class GeoTagMapBuilder {
	...
	private static void writeHtml(PrintStream ps, Iterable<PhotoLocation> photoLocations) {
		...
		ps.println(
				"    var options = { zoom:2, mapTypeId:google.maps.MapTypeId.ROADMAP, center:new google.maps.LatLng(0.0, 0.0)};");
