...
/**
 * @Description WGS84经纬度、UTM投影XY互算
 * @Author 凌霄
 * @Date 2016-7-5 下午2:45:44
 */
public class UTM {

	public static final String TAG = "UTM";
	...
	private static class SingletonHolder {
		private static final UTM sInstance = new UTM();
	}
	...
	public double[] XY2LatLon(String XY) {
		UTM2LatLon c = new UTM2LatLon();
		return c.convertUTMToLatLong(XY);
	}
	...
	public double[] LatLon2XY(double latitude, double longitude) {
		LatLon2UTM c = new LatLon2UTM();
		return c.convertLatLonToUTM(latitude, longitude);

	}

	public String LatLon2XYString(String LatLon) {
		String[] mLatLon = LatLon.split(",");
		double latitude = Double.valueOf(mLatLon[0]);
		double longitude = Double.valueOf(mLatLon[1]);
		return LatLon2XYString(latitude, longitude);
	}

	public String LatLon2XYString(double latitude, double longitude) {
		LatLon2UTM c = new LatLon2UTM();
		return c.mConvertLatLonToUTM(latitude, longitude);
	}
	...
	private class LatLon2UTM {
		public double[] convertLatLonToUTM(double latitude, double longitude) {
			...
			double UTM[] = { ((int) _easting), ((int) _northing) };
		...
		public String mConvertLatLonToUTM(double latitude, double longitude) {
			validate(latitude, longitude);
			...
			String UTM = /* longZone + latZone + "," */ +((int) _easting) + "," + ((int) _northing);
